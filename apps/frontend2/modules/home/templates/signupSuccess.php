...
<form action="<?php echo url_for('home/signup') ?>" method="post" class="form-horizontal deal">
  ...
  <div class="control-group<?php if ($form['profile']['image']->hasError()): ?> error<?php endif; ?>">
    <label class="control-label" for="inputEmail">Photo</label>
    <div class="controls">
      <?php echo $form['profile']['image']->render(); ?>
      <?php if ($form['profile']['image']->hasError()): ?>
        <span class="help-inline">Veuillez charger une photo valide</span>
      <?php endif; ?>
    </div>
  </div>
